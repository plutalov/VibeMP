...
void InitGame(RPCParameters *rpcParams)
{
...

	{
		...
		Nan::Set(data, Nan::New("playerId").ToLocalChecked(), Nan::New((int)MyPlayerID));
		Nan::Set(data, Nan::New("hostname").ToLocalChecked(), Nan::New(g_szHostName).ToLocalChecked());
		EmitEvent("gameInit", data);
	}
}
...
void ClientMessage(RPCParameters *rpcParams)
{
...

	{
		Nan::HandleScope scope;
		v8::Local<v8::Object> data = Nan::New<v8::Object>();
		Nan::Set(data, Nan::New("color").ToLocalChecked(),  Nan::New((unsigned int)dwColor));
		Nan::Set(data, Nan::New("text").ToLocalChecked(),   Nan::New(szNonColorEmbeddedMsg).ToLocalChecked());
...
void Chat(RPCParameters *rpcParams)
{
...

	{
		Nan::HandleScope scope;
		v8::Local<v8::Object> data = Nan::New<v8::Object>();
		Nan::Set(data, Nan::New("playerId").ToLocalChecked(), Nan::New((int)playerId));
		Nan::Set(data, Nan::New("text").ToLocalChecked(),     Nan::New((const char*)szText).ToLocalChecked());
		EmitEvent("chat", data);
	}
...
void RequestClass(RPCParameters *rpcParams)
{
...

	{
		Nan::HandleScope scope;
		v8::Local<v8::Object> data = Nan::New<v8::Object>();
		Nan::Set(data, Nan::New("outcome").ToLocalChecked(), Nan::New((int)byteRequestOutcome));
		Nan::Set(data, Nan::New("skin").ToLocalChecked(),    Nan::New(iLocalPlayerSkin));
		Nan::Set(data, Nan::New("x").ToLocalChecked(),       Nan::New(SpawnInfo.vecPos[0]));
		Nan::Set(data, Nan::New("y").ToLocalChecked(),       Nan::New(SpawnInfo.vecPos[1]));
		Nan::Set(data, Nan::New("z").ToLocalChecked(),       Nan::New(SpawnInfo.vecPos[2]));
		EmitEvent("requestClass", data);
	}
}
...
void ScrDialogBox(RPCParameters *rpcParams)
{
	...
	// Emit dialog event to JS
	{
		Nan::HandleScope scope;
		v8::Local<v8::Object> data = Nan::New<v8::Object>();
		Nan::Set(data, Nan::New("id").ToLocalChecked(),     Nan::New((int)sampDialog.wDialogID));
		Nan::Set(data, Nan::New("style").ToLocalChecked(),  Nan::New((int)sampDialog.bDialogStyle));
		Nan::Set(data, Nan::New("title").ToLocalChecked(),  Nan::New(sampDialog.szTitle).ToLocalChecked());
		Nan::Set(data, Nan::New("body").ToLocalChecked(),   Nan::New(sampDialog.szInfo).ToLocalChecked());
		Nan::Set(data, Nan::New("button1").ToLocalChecked(),Nan::New(sampDialog.szButton1).ToLocalChecked());
		Nan::Set(data, Nan::New("button2").ToLocalChecked(),Nan::New(sampDialog.szButton2).ToLocalChecked());
		EmitEvent("dialog", data);
	}
}
...
void ScrSetPlayerPos(RPCParameters *rpcParams)
{
...

	{
		Nan::HandleScope scope;
		v8::Local<v8::Object> data = Nan::New<v8::Object>();
		Nan::Set(data, Nan::New("x").ToLocalChecked(), Nan::New(x));
		Nan::Set(data, Nan::New("y").ToLocalChecked(), Nan::New(y));
		Nan::Set(data, Nan::New("z").ToLocalChecked(), Nan::New(z));
		EmitEvent("setPos", data);
	}
}
...
void ScrSetSpawnInfo(RPCParameters *rpcParams)
{
...

	{
		Nan::HandleScope scope;
		v8::Local<v8::Object> data = Nan::New<v8::Object>();
		Nan::Set(data, Nan::New("skin").ToLocalChecked(),    Nan::New(SpawnInfo.iSkin));
		Nan::Set(data, Nan::New("x").ToLocalChecked(),       Nan::New(SpawnInfo.vecPos[0]));
		Nan::Set(data, Nan::New("y").ToLocalChecked(),       Nan::New(SpawnInfo.vecPos[1]));
		Nan::Set(data, Nan::New("z").ToLocalChecked(),       Nan::New(SpawnInfo.vecPos[2]));
		EmitEvent("spawnInfo", data);
	}
}
